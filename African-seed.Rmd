...
library(ggpubr)
tiff("Composition_Genotype_bact.tiff.tiff", units="in", width=11, height=5, res=300)
Composition_Genotype_bact.tiff.tiff=gg1+plot_layout(nrow = 1);Composition_Genotype_bact.tiff.tiff
ggsave("Composition_Genotype_bact.tiff.tiff", plot = Composition_Genotype_bact.tiff.tiff)
dev.off()
...
library(ggpubr)
tiff("Order_Composition_Genotype_bact.tiff.tiff", units="in", width=14, height=5, res=300)
Order_Composition_Genotype_bact.tiff.tiff=gg1+plot_layout(nrow = 1);Order_Composition_Genotype_bact.tiff.tiff
ggsave("Order_Composition_Genotype_bact.tiff.tiff", plot = Order_Composition_Genotype_bact.tiff.tiff)
dev.off()
...
pcaplot1_bacteria.tiff.tiff <- ggordpoint(obj=pcares, pc=c(1, 2), biplot=F, speciesannot=F,
  ...
  theme(text=element_text(size=12,  family="sans"))+ labs(tag = "");pcaplot1_bacteria.tiff.tiff
#ggsave("pcaplot1_bacteria.tiff.TIFF", plot = pcaplot1_bacteria.tiff)
# pc = c(1, 3) to show the first & third principal components.

pcoaplot1_bacteria.tiff.tiff <- ggordpoint(obj=pcoares, biplot=F, speciesannot=F,
                        factorNames=c("Genotype"), ellips3_Bacteriae=F) +
  scale_fill_manual(values=mycola)+
  ...
  theme(text=element_text(size=12,  family="sans"))+theme(legend.position = "")+
  theme(legend.title=element_blank())+
  theme(text=element_text(size=12,  family="sans"))+ labs(tag = "");pcoaplot1_bacteria.tiff.tiff
#ggsave("pcoaplot1_bacteria.tiff.tiff.TIFF", plot = pcoaplot1_bacteria.tiff.tiff);pcoaplot1_bacteria.tiff.tiff

#Combine the figures
tiff("PCOA_Bacteria_cultitvars.tiff", units="in", width=6, height=3, res=300)
PCOA_Bacteria_cultitvars.tiff=pcaplot1_bacteria.tiff.tiff+pcoaplot1_bacteria.tiff.tiff+plot_layout(ncol = 2);PCOA_Bacteria_cultitvars.tiff
...
plot_bacterial_Shannon=ggboxplot(Bacterial_richness, x = "Genotype", y = "Shannon",fill  = "Genotype", ylab = "Shannon ASVs", xlab = "Plant genotype")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+ theme(legend.position="none") +geom_jitter(width = 0.3,alpha=0.2)+
  geom_jitter(width = 0.3,alpha=0.2)+theme(text = element_text(size = 8.5)) +scale_color_gradientn(colours = c('grey', 'pink'))+
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
...
##plot rarefaction curves  for the Fungil community
#code based on https://microsud.github.io/microbiomeutilities/articles/microbiomeutilities.html
```{r, echo=FALSE,warning = FALSE}
...
##Plot PCoA considering the cultivars
pcaplot1_fungi.tiff.tiff <- ggordpoint(obj=pcares, pc=c(1, 2), biplot=F, speciesannot=F,
  ...
  theme(text=element_text(size=12,  family="sans"))+theme(legend.position = "")+
  theme(legend.title=element_blank())+
  theme(text=element_text(size=12,  family="sans"))+ labs(tag = "");pcaplot1_fungi.tiff.tiff
#ggsave("pcaplot1_fungi.tiff.tiff", plot = pcaplot1)
# pc = c(1, 3) to show the first & third principal components.

pcoaplot1_fungi.tiff.tiff <- ggordpoint(obj=pcoares, biplot=F, speciesannot=F,
                        factorNames=c("Genotype"), ellips3_Fungie=F) +
  scale_fill_manual(values=mycola)+
  guides(fill= guide_legend(keywidth = 0.6, keyheight = 0.6, ncol=4))+
  theme(panel.grid.major = element_blank(), 
  ...
  theme(text=element_text(size=12,  family="sans"))+theme(legend.position = "")+
  theme(legend.title=element_blank())+
  theme(text=element_text(size=12,  family="sans"))+ labs(tag = "");pcoaplot1_fungi.tiff.tiff
#ggsave("pcoaplot1_fungi.tiff.tiff.TIFF", plot = pcoaplot1_fungi.tiff.tiff);pcoaplot1_fungi.tiff.tiff

#Combine the figures
tiff("PCOA_Fungi_cultitvars.tiff", units="in", width=6, height=3, res=300)
PCOA_Fungi_cultitvars.tiff=pcaplot1_fungi.tiff.tiff+pcoaplot1_fungi.tiff.tiff+plot_layout(ncol = 2);PCOA_Fungi_cultitvars.tiff
...
plot_Fungi_Shannon=ggboxplot(Fungi_richness, x = "Genotype", y = "Shannon",fill  = "Genotype", ylab = "Shannon ASVs", xlab = "Plant genotype")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+ theme(legend.position="none") +geom_jitter(width = 0.3,alpha=0.2)+
  geom_jitter(width = 0.3,alpha=0.2)+theme(text = element_text(size = 8.5)) +scale_color_gradientn(colours = c('grey', 'pink'))+
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
...
kruskal.test(Observed ~ Genotype, data = Fungil_richness)
...
# Region of tomato seed production
Fungil_Dunn_observed_genotype=dunn_test(Fungil_richness, Observed ~ Genotype, p.adjust.method = "bonferroni", detailed = FALSE);Fungil_Dunn_observed_genotype
write_csv(Fungil_Dunn_observed_genotype, "Fungil_Dunn_observed_genotype.csv")
Fungil_Dunn_observed_genotype <- dunnTest(Observed, Genotype, method = "bonferroni");Fungil_Dunn_observed_genotype
# Obtaining significance letters
library(rcompanion)
CLD_Fungil_Dunn_observed_genotype = cldList(P.adj ~ Comparison, data=Fungil_Dunn_observed_genotype$res);CLD_Fungil_Dunn_observed_genotype 
```
...
#statistics measures for the different Fungil indices
kruskal.test(Shannon ~ Genotype, data = Fungil_richness)
...
# Region of tomato seed production
Fungil_Dunn_Shannon_genotype=dunn_test(Fungil_richness, Shannon ~ Genotype, p.adjust.method = "bonferroni", detailed = FALSE);Fungil_Dunn_Shannon_genotype
write_csv(Fungil_Dunn_Shannon_genotype, "Fungil_Dunn_Shannon_genotype.csv")
Fungil_Dunn_Shannon_genotype <- dunnTest(Shannon, Genotype, method = "bonferroni");Fungil_Dunn_Shannon_genotype
# Obtaining significance letters
library(rcompanion)
CLD_Fungil_Dunn_Shannon_genotype = cldList(P.adj ~ Comparison, data=Fungil_Dunn_Shannon_genotype$res);CLD_Fungil_Dunn_Shannon_genotype 
...
distme <- get_dist(ps3_Archaea, distmethod ="bray", method="hellinger");distme
...
##Plot PCoA considering the cultivars
pcaplot1_Archaea.tiff.tiff <- ggordpoint(obj=pcares, pc=c(1, 2), biplot=F, speciesannot=F,
  ...
  theme(text=element_text(size=12,  family="sans"))+theme(legend.position = "")+
  theme(legend.title=element_blank())+
  theme(text=element_text(size=12,  family="sans"))+ labs(tag = "");pcaplot1_Archaea.tiff.tiff
#ggsave("pcaplot1_Archaea.tiff.tiff", plot = pcaplot1)
# pc = c(1, 3) to show the first & third principal components.

pcoaplot1_Archaea.tiff.tiff <- ggordpoint(obj=pcoares, biplot=F, speciesannot=F,
                        factorNames=c("Genotype"), ellips3_Archaeae=F) +
  scale_fill_manual(values=mycola)+
  guides(fill= guide_legend(keywidth = 0.6, keyheight = 0.6, ncol=4))+
  theme(panel.grid.major = element_blank(), 
  ...
  theme(text=element_text(size=12,  family="sans"))+theme(legend.position = "")+
  theme(legend.title=element_blank())+
  theme(text=element_text(size=12,  family="sans"))+ labs(tag = "");pcoaplot1_Archaea.tiff.tiff
#ggsave("pcoaplot1_Archaea.tiff.tiff.TIFF", plot = pcoaplot1_Archaea.tiff.tiff);pcoaplot1_Archaea.tiff.tiff

#Combine the figures
tiff("PCOA_Archaea_cultitvars.tiff", units="in", width=6, height=3, res=300)
PCOA_Archaea_cultitvars.tiff=pcaplot1_Archaea.tiff.tiff+pcoaplot1_Archaea.tiff.tiff+plot_layout(ncol = 2);PCOA_Archaea_cultitvars.tiff
...
Archaea_subsamp <- rarefy_even_depth(ps3_Archaea, sample.size=5500  , rngseed=5163, replace=FALSE, trimOTUs=TRUE);Archaea_subsamp#[ 1128 samples by 20 sample variables ]
...
plot_Archaea_Shannon=ggboxplot(Archaea_richness, x = "Genotype", y = "Shannon",fill  = "Genotype", ylab = "Shannon ASVs", xlab = "Plant genotype")+
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))+ theme(legend.position="none") +geom_jitter(width = 0.3,alpha=0.2)+
  geom_jitter(width = 0.3,alpha=0.2)+theme(text = element_text(size = 8.5)) +scale_color_gradientn(colours = c('grey', 'pink'))+
  theme(panel.grid.major = element_blank(), 
        panel.grid.minor = element_blank(),
...
kruskal.test(Observed ~ Genotype, data = Archaeal_richness)
...
# Region of tomato seed production
Archaeal_Dunn_observed_genotype=dunn_test(Archaeal_richness, Observed ~ Genotype, p.adjust.method = "bonferroni", detailed = FALSE);Archaeal_Dunn_observed_genotype
...
#statistics measures for the different Archaeal indices
kruskal.test(Shannon ~ Genotype, data = Archaeal_richness)
...
# Region of tomato seed production
Archaeal_Dunn_Shannon_genotype=dunn_test(Archaeal_richness, Shannon ~ Genotype, p.adjust.method = "bonferroni", detailed = FALSE);Archaeal_Dunn_Shannon_genotype
