...
# basic scatterplot
ggplot(dat, aes(x=Bacteria_richness, y=Fungal_richness, alpha=Genotype)) + 
...
ggpairs(dat, columns = 2:5, ggplot2::aes(colour=Genotype)) +
  theme(text = element_text(size = 1))  # Reduce overall text size
```
...
dat=read.csv("diversity_data.csv", header = T);dat
library(GGally)
ggpairs(dat, columns = 2:5, title="correlogram with ggpairs()") 
```


```{r}
# Nice visualization of correlations
ggpairs(dat, columns = 2:5, ggplot2::aes(colour=as.character(Genotype)))
```
...
cor.test(dat$Bacteria_richness, dat$Fungal_richness,  method = "kendall")
#Warning: Cannot compute exact p-value with ties
#	Kendall's rank correlation tau

#data:  dat$Bacteria_richness and dat$Fungal_richness
#z = 3.7155, p-value = 0.0002028
